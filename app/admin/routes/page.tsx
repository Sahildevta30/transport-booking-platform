...
export default async function RoutesPage() {
  ...
  const { data: routes, error } = await supabase.from("routes").select("id,name,origin_location_id,destination_location_id,distance_km").order("name");
